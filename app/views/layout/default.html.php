...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo public_url_for ('resources/jquery-ui/jquery-ui.theme.min.css') ?>" type="text/css" media="all" />
    <link rel="stylesheet" href="<?php echo public_url_for ('resources/js/qtip2/jquery.qtip.min.css') ?>" type="text/css" media="all" />
    ...
    <![endif]-->
    <script type="text/javascript" src="<?php echo public_url_for ('resources/js/jquery-1.11.2.min.js') ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo public_url_for ('resources/js/qtip2/jquery.qtip.min.js') ?>"></script>
